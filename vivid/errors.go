...
var (
	...
	ErrActorMessageHandlerNotFunc  = errors.New("actor context handler not func")  // Actor 消息处理函数不是函数
	ErrActorMessageHandlerNotFound = errors.New("actor context handler not found") // Actor 消息处理函数未找到
