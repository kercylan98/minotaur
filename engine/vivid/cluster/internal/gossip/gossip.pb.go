...
func (*GossipLeaderMessage_None) Descriptor() ([]byte, []int) {
	return file_gossip_proto_rawDescGZIP(), []int{16, 0}
}
...
var file_gossip_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
...
func file_gossip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gossip_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GossipActorClusterExitingMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_gossip_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GossipActorClusterExitedMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_gossip_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gossip_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GossipLeaderMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_gossip_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GossipLeaderMessage_None); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_gossip_proto_msgTypes[16].OneofWrappers = []interface{}{
