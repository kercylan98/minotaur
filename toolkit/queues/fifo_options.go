...
func (o *FIFOOptions) WithBufferSize(size uint) {
	o.BufferSize = size
}

// WithStopMode 用于设置消息队列的停止模式
func (o *FIFOOptions) WithStopMode(mode FifoStopMode) {
	o.StopMode = mode
}

// WithDequeueBufferSize 用于设置出列通道的缓冲区大小
func (o *FIFOOptions) WithDequeueBufferSize(size uint) {
	o.DequeueBufferSize = size
}

// WithDequeueFullBlock 用于设置出列通道满时是否阻塞
//   - 当设置为 true 时，出列通道满时会阻塞，否则会丢弃新的消息
func (o *FIFOOptions) WithDequeueFullBlock(block bool) {
...
func (o *FIFOOptions) WithPickUpDiscarded(pickUp bool) {
