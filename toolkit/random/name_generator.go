...
func (n *NameGenerator) AddLastNames(lastNames ...string) {
	n.lastNames = append(n.lastNames, lastName...)
}

func (n *NameGenerator) AddFirstNames(firstNames ...string) {
	n.firstNames = append(n.firstNames, firstNames...)
}

func (n *NameGenerator) SetFirstNameCount(count int) {
	n.firstNameCount = count - 1
}

func (n *NameGenerator) RandomName() string {
	var builder strings.Builder
	builder.WriteString(n.lastNames[IntN(len(n.lastNames))])
	for i := 0; i <= IntN(n.firstNameCount); i++ {
		builder.WriteString(n.firstNames[IntN(len(n.firstNames))])
	}
...
func DefaultEnglishNameGenerator() *NameGenerator {
	return &NameGenerator{
		...
		firstNames: []string{
			...
			"Gabriel", "Joe", "Logan", "Alan", "Juan", "Albert", "Willie", "Elijah", "Wayne", "Randy", "Vincent",
			"Mason", "Roy", "Ralph", "Bobby", "Russell", "Bradley", "Philip", "Eugene",
			"Mary", "Patricia", "Jennifer", "Linda", "Elizabeth", "Barbara", "Susan", "Jessica", "Sarah", "Karen",
			"Lisa", "Nancy", "Betty", "Sandra", "Margaret", "Ashley", "Kimberly", "Emily", "Donna", "Michelle",
			"Carol", "Amanda", "Melissa", "Deborah", "Stephanie", "Dorothy", "Rebecca", "Sharon", "Laura",
			"Cynthia", "Amy", "Kathleen", "Angela", "Shirley", "Brenda", "Emma", "Anna", "Pamela", "Nicole",
			"Samantha", "Katherine", "Christine", "Helen", "Debra", "Rachel", "Carolyn", "Janet", "Maria",
			"Catherine", "Heather", "Diane", "Olivia", "Julie", "Joyce", "Victoria", "Ruth", "Virginia",
			"Lauren", "Kelly", "Christina", "Joan", "Evelyn", "Judith", "Andrea", "Hannah", "Megan", "Cheryl",
			"Jacqueline", "Martha", "Madison", "Teresa", "Gloria", "Sara", "Janice", "Ann", "Kathryn", "Abigail",
			"Sophia", "Frances", "Jean", "Alice", "Judy", "Isabella", "Julia", "Grace", "Amber", "Denise",
			"Danielle", "Marilyn", "Beverly", "Charlotte", "Natalie", "Theresa", "Diana", "Brittany", "Doris",
			"Kayla", "Alexis", "Lori", "Marie",
		},
		lastNames: []string{
			"Smith", "Johnson", "Brown", "Williams", "Jones", "Garcia", "Miller", "Davis", "Rodriguez", "Martinez",
			"Hernandez", "Lopez", "Gonzales", "Wilson", "Anderson", "Thomas", "Taylor", "Moore", "Jackson", "Lee",
			"White", "Clark", "Lewis", "Walker", "Hall", "Allen", "Young", "King", "Wright", "Scott",
			"Taylor", "Harris", "Martin", "Thompson", "Martinez", "Robinson", "Clark", "Rodriguez", "Lewis", "Lee",
